...
public class CarsDAO implements DAO<Cars, Integer> {
    private final static String INSERT="INSERT INTO cars (id,model,tuition) VALUES (?,?,?)";
    private final static String UPDATE="UPDATE cars SET model = ?, tuition = ? WHERE id = ?";
    private final static String FINDALL="SELECT c.id, c.model, c.tuition FROM cars AS c";
    private final static String FINDBYID="SELECT c.id, c.model, c.tuition FROM cars AS c WHERE c.id = ?";
    private final static String FINDBYMODEL ="SELECT c.id, c.model, c.tuition FROM cars AS c WHERE c.model = ?";
    private final static String DELETE="DELETE FROM cars WHERE id = ?";
    private final static String FINDINGARAGE ="SELECT c.id, c.model, c.tuition FROM cars AS c WHERE c.id = ?";
